                ...
                when (val screen = currentScreen) {
                    ...
                    is Screen.Order -> {
                        OrderScreen(
                            ...
                            customerCount = screen.customerCount, // ★追加
                            onBackClicked = {
                                currentScreen = Screen.TableList
                            }
                        )
                    }
...
//import com.pos.client.viewmodel.OrderViewModel
//import com.pos.client.viewmodel.TableListViewModel
//import com.pos.client.viewmodel.KitchenViewModel // ★追加
//import retrofit2.Retrofit
//import retrofit2.converter.gson.GsonConverterFactory
//
//sealed class Screen {
//    data object TableList : Screen()
//    data class Order(val tableId: Int, val bookId: Int, val existingOrderId: Int?) : Screen()
//    data object Kitchen : Screen()
//}
//
//private val gson = Gson()
...
//                when (val screen = currentScreen) {
//                    is Screen.TableList -> {
//                        // テーブル一覧画面にキッチンへの遷移ボタンを追加するためScaffoldで囲む
//                        Scaffold(
//                            topBar = {
//                                TopAppBar(
//                                    title = { Text("POS Client: テーブル一覧") },
...
//                                        currentScreen = Screen.Order(table.tableId, 1, table.orderId)
//                                    }
//                                )
//                            }
//                        }
...
//                    is Screen.Kitchen -> {
//                        KitchenScreen(
//                            viewModel = kitchenViewModel, // ★ここでのエラーが解消されます
//                            onBackClicked = {
//                                currentScreen = Screen.TableList
//                            }
//                        )
